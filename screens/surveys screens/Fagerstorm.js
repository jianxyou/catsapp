        ...
        if (askAdditionalQuestion) {
            return (
                <View>
                    ...
                    <Button title="current smoker" onPress={() => setSurveyType('B')} />
                    <Button title="non-somker" onPress={() => setSurveyType('C')} />
                </View>
            );
        } else {
            return (
                <View>
                    ...
                    <Button title="Yes" onPress={() => setSurveyType('A')} />
                    <Button title="No" onPress={() => setAskAdditionalQuestion(true)} />
                </View>
            );
        }
    }
