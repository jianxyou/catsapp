...
function SL25_pet_fr_Screen({ navigation }) {
  ...
  const newButtons = createLinks({
    displayNames: [...displayNamesSelf.slice(57, 60),...displayNamesSelf.slice(7,8),...displayNamesSelf.slice(41,42),...displayNamesSelf.slice(55,56)],
    internalNames: [...internalNamesSelf.slice(57, 60),...internalNamesSelf.slice(7,8),...internalNamesSelf.slice(41,42),...internalNamesSelf.slice(55,56)],
    navigation: navigation,
    filled: filled,
  });
  // setButtons(newButtons);
...
export default SL25_pet_fr_Screen;
