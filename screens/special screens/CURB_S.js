...
function CURB_S_Screen({ navigation }) {
  ...
  const newButtons = createLinks({
    displayNames: [ ...displayNamesSelf.slice(21,22), ...displayNamesSelf.slice(15,16),...displayNamesSelf.slice(23,25),...displayNamesSelf.slice(35, 36), ...displayNamesSelf.slice(37, 38)],
    internalNames: [...internalNamesSelf.slice(21,22),  ...internalNamesSelf.slice(15,16),...internalNamesSelf.slice(23,25),...internalNamesSelf.slice(35, 36), ...displayNamesSelf.slice(37, 38)],
    navigation: navigation,
    filled: filled,
  });
  // setButtons(newButtons);
