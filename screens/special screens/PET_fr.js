...
function PET_fr_Screen({ navigation }) {
  ...
  const newButtons = createLinks_Pet({
    displayNames: [...displayNamesSelf.slice(57,60), ...displayNamesSelf.slice(7,8),...displayNamesSelf.slice(41,42)],
    internalNames: [...internalNamesSelf.slice(57,60),...internalNamesSelf.slice(7,8),...internalNamesSelf.slice(41,42)],
    navigation: navigation,
    filled: filled,
  });
  // setButtons(newButtons);
