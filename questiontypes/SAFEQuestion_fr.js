...
const SAFEQuestion_fr = ({q, scale, values, num, callback}) => {
    ...
    <View style={styles.singlequestion}>
      ...
      <View style={styles.labels}>
        <Text style={styles.labeltext}>pas stressant</Text>
        <Text style={styles.labeltext}>extrêmement stressant</Text>
      </View>
...
export default SAFEQuestion_fr;